...
fun HeartRateScreen(viewModel: HeartRateViewModel, navController: NavController) {
    ...
    Column(
        ...
        ScreenMenu(navController = navController, currentRoute = "hr")
...
fun Vo2MaxScreen(viewModel: Vo2MaxViewModel, navController: NavController) {
    ...
    Column(
        ...
        ScreenMenu(navController = navController, currentRoute = "vo2max")
...
fun ConnectionSettingsScreen(
    ...
    Column(
        ...
        ScreenMenu(navController = navController, currentRoute = "connections")
...
@Composable
private fun ScreenMenu(navController: NavController, currentRoute: String) {
